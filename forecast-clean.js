function aviaCleanForecast(){
  ...
  const states=[
    ...
    {d:'1.68M',f:'-4%',h:[[56,96],[84,64],[112,98],[138,70],[162,58],[184,88]],p:[[184,88],[220,94],[254,86],[288,74]],top:[[184,88],[220,78],[254,62],[288,50]],bot:[[288,100],[254,112],[220,108],[184,88]]}
  ];
  ...
  let i=1;apply(states[i]);setInterval(()=>{i=i?0:1;apply(states[i])},1800);
}
