const translations = {
  es: {
    ...
    contactTag: "Contacto",
    contactTitle: "Habla con Aurora, nuestra agente de contacto",
    auroraName: "Aurora · Agente Avia Rockets",
    auroraText: "Te ayuda a evaluar tu cartera, recomendar plan y coordinar la activación inicial en menos de 24 horas.",
    auroraMail: "Escribir a Aurora",
    auroraDemo: "Solicitar demo guiada",
  ...
  en: {
    ...
    contactTag: "Contact",
    contactTitle: "Talk to Aurora, our contact agent",
    auroraName: "Aurora · Avia Rockets Agent",
    auroraText: "She helps you evaluate your portfolio, choose the right plan, and launch in under 24 hours.",
    auroraMail: "Email Aurora",
    auroraDemo: "Request guided demo",
    aboutTag: "About us",
